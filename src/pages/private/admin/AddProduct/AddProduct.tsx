    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            gallery.forEach((file, i) => { 
                if (i < 5) data.append(`image_${i + 2}`, file); 
            });
                ...
                <div className="lg:col-span-8 space-y-6">
                    <div className="bg-white p-6 md:p-8 rounded-3xl border border-zinc-200 shadow-sm space-y-8">
                        ...
                        <div className="pt-6 border-t border-zinc-100">
                            ...
                            {hasVariations ? (
                                /* FIX: overflow-visible para o select não ser cortado */
                                <div className="border border-zinc-200 rounded-2xl bg-white overflow-visible">
                                    <table className="w-full text-left border-collapse" style={{ tableLayout: 'fixed' }}>
                                        ...
                                        <tbody>
                                            {variations.map((v, i) => (
                                                /* FIX: z-index decrescente para que o select da linha de cima sobreponha a de baixo */
